...
export function FormTicket({customer}: FormTicketProps) {
  ...
  return (
    <form className="bg-slate-200 mt-6 px-4 py-6 rounded border-2" onSubmit={handleSubmit(handleRegister)}>
      ...
      ></textarea>
      {errors.description && (
        <p className="bg-red-200 my-1 mt-1 mb-4">{errors.description.message}</p>
      )}
      <button
        type="submit"
